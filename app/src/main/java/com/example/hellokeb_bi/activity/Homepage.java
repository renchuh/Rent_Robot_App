...
public class Homepage extends AppCompatActivity {
    ...
    private int townNumber, countryNumber;
    ...
    public void init() {
        ...
        mediator = new HomePageMediator(this, mSpn, mSpn2, startTime_tv, endTime_tv, dialogFactory.createErrorDialog(), progressBar, homepage_search);
    }
